...
ifeq ($(CONFIG_CYW43438), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw43438
...
ifeq ($(CONFIG_BCM43456), y)
	CONFIG_BCMDHD_MODULE_NAME := bcm43456
	CONFIG_BCMDHD_WPA3 := n
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW43455), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw43455
...
ifeq ($(CONFIG_CYW4354), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw4354
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW4373), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw4373
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
