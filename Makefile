...
CONFIG_BCMDHD_FIRMWARE_MAPPING := y
CONFIG_DHD_MAP_CHIP_FIRMWARE_WITH_CHIP_MODULE := n

ifeq ($(CONFIG_CYW43438_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw43438_sdio
	CONFIG_BCMDHD_WPA3 := n
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
endif

ifeq ($(CONFIG_BCM43456_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := bcm43456_sdio
	CONFIG_BCMDHD_WPA3 := n
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW43455_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw43455_sdio
...
ifeq ($(CONFIG_CYW4354_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw4354_sdio
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW4373_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw4373_sdio
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW43012_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw43012_sdio
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW54591_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw54591_sdio
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW54591_PCIE), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw54591_pcie
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_PCIE := y
	DHDCFLAGS += -DIGUANA_LEGACY_CHIPS
endif

ifeq ($(CONFIG_CYW5557X_SDIO), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw5557x_sdio
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_SDIO := y
	CONFIG_BCMDHD_OOB := y
	CONFIG_BCMDHD_SDMMC := y
...
ifeq ($(CONFIG_CYW5557X_PCIE), y)
	CONFIG_BCMDHD_MODULE_NAME := cyw5557x_pcie
	CONFIG_BCMDHD_WPA3 := y
	CONFIG_BCMDHD_PCIE := y
	CONFIG_BCMDHD_WIFI6_6E := y
	DHDCFLAGS += -DIGUANA_LEGACY_CHIPS
...
# can re-init the Wi-Fi.
DHDCFLAGS += -DEXPLICIT_DISCIF_CLEANUP

# Enable debugability
DHDCFLAGS += -DDEBUGABILITY

# Enable firmware/nvram/clm_blob mapping
ifeq ($(CONFIG_BCMDHD_FIRMWARE_MAPPING), y)
	DHDCFLAGS += -DDHD_MAP_CHIP_FIRMWARE_PATH

# Enable custom firmware path
ifeq ($(CONFIG_BCMDHD_FIRMWARE_DIR_PATH),)
	DHDCFLAGS += -DDHD_FIRMWARE_DIR_PATH=\"/vendor/etc/firmware\"
else
	DHDCFLAGS += -DDHD_FIRMWARE_DIR_PATH=\"$(CONFIG_BCMDHD_FIRMWARE_DIR_PATH)\"
endif

# Enable chip module mapping
ifeq ($(CONFIG_DHD_MAP_CHIP_FIRMWARE_WITH_CHIP_MODULE), y)
	DHDCFLAGS += -DDHD_MAP_CHIP_FIRMWARE_WITH_CHIP_MODULE
endif
endif
...
ifeq ($(CONFIG_BCMDHD_ROCKCHIP_PLATFORM), y)
...
ifneq ($(CONFIG_BCMDHD),)
$(CONFIG_BCMDHD_MODULE_NAME)-objs := $(DHDOFILES)
obj-$(DRIVER_TYPE)   += $(CONFIG_BCMDHD_MODULE_NAME).o
endif

ifneq ($(CONFIG_BCMDHDX),)
$(CONFIG_BCMDHD_MODULE_NAME)-dhdx-objs := $(DHDOFILES)
obj-$(DRIVER_TYPE) += $(CONFIG_BCMDHD_MODULE_NAME).o $(CONFIG_BCMDHD_MODULE_NAME)-dhdx.o
endif
